         ...
         <div class="col-lg-8 posts-list">
               ...
               <div class="blog_details">
                  ...
                  <ul class="blog-info-link mt-3 mb-4">
                     <?php 
                        ...
                        $author_url = get_the_author_meta('user_login', $author);
                     ?>
               ...
               <div class="navigation-area">
                  <div class="row">
                     <div class="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
                        <?php
                           if($pre_post = get_previous_post()){
                              $pre_post_thumb = get_the_post_thumbnail($pre_post->ID, 'thumbnail');
                              $pre_post_title = get_the_title($pre_post->ID);
                           ?>
                              <div class="thumb">
                                 <?php previous_post_link( '%link', $pre_post_thumb);?>
                              </div>
                              <div class="arrow">
                                 <a href="#">
                              ...
                              <div class="detials">
                                 <p>Prev Post</p>
                                 <h4><?php previous_post_link( '%link', $pre_post_title);?></h4>
                              </div>
                        <?php
                           } else if(empty($pre_post = get_previous_post())) {
                              echo 'No Have More Previous post';
                           }                            
                        ?>
                     ...
                     <div class="col-lg-6 col-md-6 col-12 nav-right flex-row d-flex justify-content-end align-items-center">
                        ...
                        <?php
                           } else if(empty($next_post = get_next_post())) {
                              echo 'No Have More Next Post';
                           }
                        ?>
                     </div>
                  </div>
            ...
            <div class="blog-author">
               <?php 
                  $author = $post->post_author;
                  $author_name = get_the_author_meta( 'display_name', $author );
                  $author_desc = get_the_author_meta( 'user_description', $author );
                  $author_avatar = get_avatar_url($author );
               ?>
